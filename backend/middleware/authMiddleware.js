...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (currentUser.activeSessionId && decoded.sessionId !== currentUser.activeSessionId) {
    return next(new AppError('Your session has expired because you logged in from another device. Please log in again.', 401));
  }
